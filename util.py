...
def graph_to_mask(num_spixels_width, num_spixels_height, S, cc, stride, image_tensor, image, plabels):
    ...
    S = np.array(torch.reshape(S, (num_spixels_height, -1)))
    # print("inside graph to mask")
    # print(f"S: {S.shape}, {S}")
